...
def parse_args(arguments=None) -> argparse.Namespace:
	...
	# Supported modes for running MUDscope
	modes_list = [MODE_MUDGEN, MODE_REJECT, MODE_FLOWS_GENERATION, MODE_ANALYZE]
	parser.add_argument(
		'mode',
		choices = modes_list,
		help    = "mode in which to run MUDscope",
	)
	...
	group_mudgen = parser.add_argument_group(
		title       = 'Mode: mudgen',
		description = 'Creates MUD files from benign network traces. '
		              'Required arguments when mode is mudgen.',
	)
	...
	group_reject = parser.add_argument_group(
		title       = 'Mode: reject',
		description = 'Filters MUD rejected traffic from pcap files. '
		              'Required arguments when mode is reject.',
	)
	...
	group_flows_gen = parser.add_argument_group(
		...
		description = 'Transforms MRT pcap files to NetFlows. '
		              'Required arguments when mode is flows_gen.',
	)
	...
	group_analyze = parser.add_argument_group(
		title       = 'Mode: analyze',
		description = 'Analyzes NetFlows, performs characterization and '
					  'evolution analysis. '
		              'Required arguments when mode is analyze.',
	)

	# Set possible analysis actions
	analysis_actions_list = [
